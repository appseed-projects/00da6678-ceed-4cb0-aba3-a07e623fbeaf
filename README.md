...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-17 18:08`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/00da6678-ceed-4cb0-aba3-a07e623fbeaf.git
$ cd 00da6678-ceed-4cb0-aba3-a07e623fbeaf
```
